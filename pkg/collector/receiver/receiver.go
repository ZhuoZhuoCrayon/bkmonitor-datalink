...
func (r *Receiver) startTarsServer() error {
	...
	conf := &tarsTransport.TarsServerConf{
		...
		AcceptTimeout:  tars.AcceptTimeout,
		ReadTimeout:    tars.ReadTimeout,
		WriteTimeout:   tars.WriteTimeout,
		HandleTimeout:  tars.HandleTimeout,
		IdleTimeout:    tars.IdleTimeout,
		QueueCap:       tars.QueueCap,
		TCPReadBuffer:  tars.TCPReadBuffer,
		TCPWriteBuffer: tars.TCPWriteBuffer,
		TCPNoDelay:     tars.TCPNoDelay,
	}
	s := define.NewTarsProtocol(serviceMgr.tarsServants, true)
