...
type serviceManager struct {
	...
	tarsServants map[string]*define.TarsServant
}
...
func registerRecvTarsRoute(o string, server string, impl interface{}, dispatch define.TarsDispatch, mgr *serviceManager) error {
	s := define.NewTarsServant(o, server, impl, dispatch)
...
// RegisterRecvTarsRoute 注册 Tars Servant
func RegisterRecvTarsRoute(o string, server string, impl interface{}, dispatch define.TarsDispatch) {
